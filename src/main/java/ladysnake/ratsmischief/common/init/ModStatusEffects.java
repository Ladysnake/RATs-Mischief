...
public interface ModStatusEffects {
	...
	StatusEffect RAT_CURSE = createStatusEffect("rat_curse", new RatCurseStatusEffect(StatusEffectCategory.NEUTRAL, 0x31363F));
	StatusEffect RAT_CURSE_COOLDOWN = createStatusEffect("rat_curse_cooldown", new RatCurseCooldownStatusEffect(StatusEffectCategory.NEUTRAL, 0x31363F));
