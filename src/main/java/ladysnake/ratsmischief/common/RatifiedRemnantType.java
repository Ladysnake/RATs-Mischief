...
//            return this.player.world.getEntityById(this.player.getEntityId()) == this.player;
//        }
//
//        @Override
...
//                    MobEntity rat = possessionComponent.getPossessedEntity();
//
//                    if (rat != null) {
//                        rat.remove(RemovalReason.DISCARDED);
...
//                ((RatEntity) possessedEntity).setEating(this.player.isUsingItem());
