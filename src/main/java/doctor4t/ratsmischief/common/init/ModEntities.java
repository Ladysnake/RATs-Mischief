...
public interface ModEntities {
	...
	public static EntityType<RatEntity> RAT = createEntity("rat", QuiltEntityTypeBuilder.<RatEntity>createMob().entityFactory(RatEntity::new).defaultAttributes(RatEntity.createRatAttributes()).setDimensions(EntityDimensions.changing(0.6F, 0.4F)).maxChunkTrackingRange(128).build());
